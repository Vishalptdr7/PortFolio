...
const Data = () => {
  ...
  const originalText = "Vishal Patidar";
  ...
  return (
    <div className="home__data">
      ...
      <p className="home__description">
        I am a MERN Stack Developer with comprehensive knowledge of front-end
        and back-end technologies. Passionate about creating innovative web
        applications and continuously enhancing my skills. Looking forward to
        contributing to impactful projects.
      </p>
      <p className="home__description">
        I have completed my Bachelor of Science (B.Sc) from DAVV, Indore.
        Currently, a student of NIT Bhopal enrolled in MCA program.
      </p>
    </div>
  );
};
