...
import CV from "../../src/assets/Vishal Resume.pdf";
      ...
      <div className="about__container container grid">
        ...
        <div className="about__data">
          <p className="about__description">
            ...
            specialize in creating responsive, dynamic, and secure web
            solutions. With a passion for clean code and scalable architecture,
            I bring backend logic and frontend interactivity together to deliver
